...
-- ============================================
-- 3b. BUILDING JOINER COUNTS FUNCTION (alias)
-- Same as get_new_joiners_count, named for clarity
-- Used by Edge Function and client service
-- ============================================
CREATE OR REPLACE FUNCTION get_building_joiner_counts(p_building_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
-- Grant execute permission to authenticated users
GRANT EXECUTE ON FUNCTION get_building_joiner_counts(uuid) TO authenticated;
